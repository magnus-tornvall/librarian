...
## 5. Decisions register → [`decisions.md`](./decisions.md)

**Moved 2026-08-02.** The settled rulings — and the register of durable **D-ids** the
architecture model links to — live in [`decisions.md`](./decisions.md). Nothing was
rewritten; the section was lifted whole so this document can shrink toward an index.

References to "§5" elsewhere in this document mean that file. Start with its register
table: sixteen rulings, each with an id, what it holds in place, and where its reasoning
lives.
...
## 15. Open items → [`triggers.md`](./triggers.md)

**Moved 2026-08-02.** The deferrals, and the register of durable **T-ids** naming the
condition each one waits for, live in [`triggers.md`](./triggers.md). Nothing was
rewritten; the section was lifted whole.

References to "§15" elsewhere in this document mean that file. A trigger id is
permanent — `T-10` means the same thing there, in `docs/architecture/librarian.c4`, and
in an issue that says "blocked by T-10".
